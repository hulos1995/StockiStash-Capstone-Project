    ...
    <main className='page-body page-body--tabbed-layout'>
      ...
      <section
        className={`page-body-container ${
          isDarkMode
            ? 'page-body-container--dark'
            : 'page-body-container--light'
        }`}
      >
          ...
          {activeTab === 1 && (
            <div className='page-body__tab-pane'>
              ...
              <p className='page-body__section-description'>
                Explore the range of services I offer to streamline your
          ...
          {activeTab === 2 && (
            <div className='page-body__tab-about'>
              <div className='page-body__section-about'>
                ...
                <p className='page-body__section-description'>
                  This website provides effective inventory solutions designed
                  to simplify operations for businesses of any size. The
                  platform ensures efficient tracking, affordable storage
                  management, and easy item identification, helping maintain a
                  steady workflow. It also supports employees with clear,
                  detailed information and visuals. Besides are jobs that have
                  been polished from strach.
                </p>
              </div>
              <GallarySlider />
            </div>
            ...
            <div className='page-body__tab-pane'>
              ...
              <div className='page-body__section-description'>
                <div className='page-body__section-container'>
                  <a
                    href='https://www.linkedin.com/in/hoang-nguyen-bao/ '
                    target='_blank'
                ...
                <div className='page-body__section-container'>
                  <a
                    target='_blank'
                    rel='noopener noreferrer'
                    href='https://www.facebook.com/profile.php?id=100009348904627'
                  >
                    <img
                      className='page-body__section-container-image'
                      src={facebook}
              ...
              <a
                href='bao960045@yahoo.com'
                target='_blank'
                className='page-body__contact-info'
              >
